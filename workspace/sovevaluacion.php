      ...
      <div class="container">
        <div class="row">
          <h1 style="font-family: 'Roboto', sans-serif;
                  	...
                  	padding-bottom: 10px;
                  	font-size: 70px;
                  	color: #002C55;">SOV EVALUACIÓN</h1>
        </div>
        <div class="row">
          <h5 style="font-family: 'Roboto', sans-serif;
                  	    ...
                  	    text-align: left;
                    	padding-bottom: 30px;
                    	color: #002E54;">EVALUA EN FORMA PRÁCTICA EL DESEMPEÑO DE SU PERSONAL EXTERNO, DE TUS SUCURSALES DESDE UN PUNTO DE VISTA OPERATIVO Y TENIÉNDOLO EN TIEMPO REAL EL CONOCIMIENTO DE LAS ACTIVIDADES</h5>
        </div>
      </div>
    </div>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-sm">
      <h5 class="subtitulo">CLARIFICA LAS ÁREAS DE OPORTUNIDAD EN DONDE DEBES FOCALIZAR LAS ACCIONES A REALIZAR</h5>
    </div>
  </div>
</div>
