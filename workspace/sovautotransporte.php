...
<div class="container">
  ...
  <div class="col-sm-5" style="vertical-align:middle">
    ...
    <div class="col-sm-7">
        <img src="./images/grafica_autotranporte.svg" style="width:90%;height:90%;"></img>
    </div>
  </div>
</div>
...
<div style="background-image: url('fondo.png');background-repeat: no-repeat;background-size:100% 100%;">
    <div class="container" style="padding-top:2%;padding-bottom:2%;border-color:transparent">
            ...
            <div class="card tarjeta" id="fondodegrad2cuad">
                        <div class="card-body">
                            <table>
                                ...
                                <tr>
                                    <td>
                                         <img style="width:92px;height:96px;" src="./images/icono funcionamiento.svg"/>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="card-body">
                            <table>
                                <tr>
                                    <td>
                                        <p class="card-text textoTarjeta" id="tarjetasdegradconicono">
                                            Soporte técnico por personal calificado 24/7 los 365 días del año
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                         <img style="width:92px;height:96px;" src="./images/celular icon.svg"/>
                                    </td>
                                </tr>
                            </table>
                        </div>
        ...
        <div class="row">
            <div class="col-sm" style="display:flex;">
            <div class="card tarjeta" id="fondodegrad2cuad">
                        <div class="card-body" style="display: table; height: 260px; overflow: hidden;">
                        <div align="center" style="display: table-cell; vertical-align: middle;">
                            <table style="text-align:center;">
                                <tr>
                                    <td>
                                        <p class="card-text textoTarjeta" id="tarjetasdegradconicono">
                                            SOV se encuentra alojado en los servidores de la empresa Hostgator, los cuales garantizan 99.9% uptime.
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                         <img style="width:92px;height:96px;" src="./images/icono_nube.svg"/>
                                    </td>
                                </tr>
                            </table>
                        </div>
            ...
            <div class="col-sm" style="display:flex;flex:1;">
            <div class="card tarjeta" id="fondodegrad2cuad">
                        <div class="card-body" style="display: table; height: 260px; overflow: hidden;">
                        <div align="center" style="display: table-cell; vertical-align: middle;">
                            <table align="center" style="text-align:center;">
                                <tr>
                                    <td>
                                        <p class="card-text textoTarjeta" id="tarjetasdegradconicono">
                                            Bajo licencia con Google Maps
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                         <br/><img style="width:92px;height:96px;" src="./images/google icon.svg"/>
                                    </td>
                                </tr>
                            </table>
                            </div>
